              ...
              {[
                {
                  ...
                  description:
                    "Helping businesses grow with tailored, efficient, and scalable web solutions using the MERN stack.",
                  // icon: "👨‍💻",
                  achievements: [
                ...
                },
                {
                  ...
                  description:
                    "Independent Frontend Developer crafting responsive, user-friendly, and visually appealing web interfaces.",
                  // icon: "🚀",
                  achievements: [
                ...
                >
                  ...
                  >
                    ...
                    <div className="mt-8">
                      <h3
                        className="text-2xl font-bold mb-2 bg-gradient-to-r from-blue-500 to-purple-500 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Explore our collection of modern, classic, and custom designs to elevate your home or office!",
                  image: durgesh,
                  tech: ["JavaScript", "HTML", "CSS", "Bootstrap"],
                ...
                // },
                {
                  ...
                  description:
                    "Delicious cuisine, exceptional service! We cater for all events, from weddings to corporate gatherings",
                  image: madhuprem,
                  tech: ["JavaScript", "HTML", "CSS", "Bootstrap"],
                ...
                // },
                {
                  ...
                  description:
                    "Unlock knowledge and skills with our expert-led courses and resources. Empowering learners for a brighter future!",
                  image: shinde,
                  tech: ["JavaScript", "HTML", "CSS", "Bootstrap"],
                ...
                },
                {
                  ...
                  description:
                    "Explore the world with seamless travel experiences! Discover amazing destinations, exclusive deals, and unforgettable adventures.",
                  image: shiv,
                  tech: ["JavaScript", "HTML", "CSS", "Bootstrap"],
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              <motion.form
                ...
                onSubmit={(e) => {
                  ...
                  window.open(`https://wa.me/+918080542695?text=${whatsappMessage}`, "_blank")
                }}
              >
